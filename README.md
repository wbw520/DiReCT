...
We use the LLama3-8B for this evaluation. Our prompt refer to utils/dataextraction.py discriminate_similarity_observation() and  def discriminate_similarity_reason()
